        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                if (matches.size() == 0) {
                    ...
                    if (mostLikelyThingHeard.equalsIgnoreCase("SUBMIT")) {
                        startActivity(new Intent(this, CurrentCrime.class));
                    } else if (mostLikelyThingHeard.equalsIgnoreCase("CURRENT")) {
                        current.setChecked(true);
                        later.setChecked(false);
                    } else if (mostLikelyThingHeard.equalsIgnoreCase("CHOOSE")) {
